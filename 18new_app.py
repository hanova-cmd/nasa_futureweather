...
def apply_seasonal_css(season):
    ...
    .main-header {{
        font-size: 3.5rem;
        background: linear-gradient(45deg, #005288, #0076A8, #0094D2, #00B2FF);
    ...
    .forecast-card {{
        background: linear-gradient(135deg, #EBF5FB 0%, #F4F6F6 100%);
        padding: 1.5rem;
        border-radius: 12px;
        margin: 1rem 0;
    ...
    /* Improved Streamlit native elements */
